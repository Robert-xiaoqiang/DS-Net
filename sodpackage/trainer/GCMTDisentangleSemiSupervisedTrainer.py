...
class GCMTDisentangleSemiSupervisedTrainer(MTSemiSupervisedTrainer):
    ...
    def wrap_model(self):
        self.model = GCMTDisentangleFullModel(self.model, self.criterion)
    ...
    def build_criterion(self):
        ...
        # sod consistency for unlabeled
        # depth consistency for unlabeled
        # gate consistency for unlabeled
