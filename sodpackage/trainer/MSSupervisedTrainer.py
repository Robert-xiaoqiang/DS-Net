...
from ..helper.TrainHelper import AverageMeter, LoggerPather, DeviceWrapper, MSFullModel
...
class MSSupervisedTrainer(SupervisedTrainer):
    ...
    def wrap_model(self):
        self.model = MSFullModel(self.model, self.criterion)
