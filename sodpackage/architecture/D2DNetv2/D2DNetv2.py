...
class ComplementaryGatedFusion(nn.Module):
    ...
    def forward(self, from_depth_estimation, from_rgb, from_depth_extraction):
        ...
        y = [ self.dams[i](from_rgb[i], from_depth_extraction[i]) for i in range(self.ns) ]
...
class D2DNetv2(nn.Module):
    ...
    def forward(self, rgb, depth):
        ...
        adaptive_combination = self.cgf(None, from_rgb, from_depth_extraction)
