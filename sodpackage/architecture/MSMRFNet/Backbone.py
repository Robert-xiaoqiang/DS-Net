...
class HRNet(nn.Module):
    ...
    def __init__(self, config, inplanes = 3):
        super().__init__()
        extra = config.MODEL.EXTRA
        self.inplanes = inplanes
        self.stage_channels = [ ] # list of list
        ...
        self.stage_channels.append([ stage1_out_channel ])
        ...
        self.stage_channels.append(pre_stage_channels)
    ...
    def forward(self, x):
        ...
        x_stage1 = [ x ] # wrap it as 1-element list
        ...
        return x_stage1, x_stage2, x_stage3, x_stage4
        ...
        if os.path.isfile(pretrained):
            ...
            for k, v in pretrained_dict.items():
                if k in model_dict.keys():
                    if k.startswith('conv1') and self.inplanes == 1:
                        continue
                    filtered_dict[k] = v
